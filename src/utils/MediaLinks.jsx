...
export default function MediaLinks() {
  return <>
    ...
    <a href="https://www.tiktok.com/@sfcollab_official" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition"><Tiktok className="w-6 h-6" /></a>
