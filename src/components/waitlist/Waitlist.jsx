...
import { Sparkles, Users, Gift, ArrowRight } from 'lucide-react'

export default function Waitlist() {
  return (

    <div className="bg-[#0b0b0b] text-white relative min-h-screen overflow-y-auto">
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl relative z-10">
        ...
        <div className="my-12 max-w-2xl mx-auto">
          <div className=" rounded-2xl bg-linear-to-r from-blue-600/20 to-purple-600/20 border border-white/20 backdrop-blur-sm p-6 hover:border-white/40 transition-all duration-300">
            <div className="z-10">
              <div className="mb-6">
              ...
              <ul className="space-y-3 text-sm mb-6">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-white/80">First 1,000 by Jan 10th = <span className="font-semibold text-blue-300">3 months free</span></span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-purple-400 font-bold">✓</span>
                  <span className="text-white/80">First 10,000 by Feb 2nd = <span className="font-semibold text-purple-300">1 month free</span></span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-pink-400 font-bold">✓</span>
                  <span className="text-white/80"><span className="font-semibold text-pink-300">Limited time</span> offer</span>
                </li>
              </ul>
