  ...
  return (
    <motion.div
        ...
        {notifications.map((notification, i) => (
          <motion.div
            ...
            <div className="flex justify-between items-center">
              ...
              {notification.count && (
                <div
                  className="flex items-center text-xs gap-0.5 font-medium text-neutral-500 dark:text-neutral-300">
      ...
      <div className="flex items-center gap-2">
        <div
          className="size-5 rounded-full bg-neutral-400 text-white text-xs flex items-center justify-center font-medium">
