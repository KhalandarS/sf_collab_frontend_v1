          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-white/20 backdrop-blur-sm p-6">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6">
              ...
              <div className="flex gap-4 flex-shrink-0">
                <a href="/waitlist" className="group relative px-6 py-3 bg-blue-500/80 hover:bg-blue-600 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 border border-blue-400/50 hover:border-blue-300">
