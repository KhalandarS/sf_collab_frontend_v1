...
//           {/* Observer */}
//           <div className="rounded-2xl border border-gray-200 bg-[#111111] p-6">
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4">
        ...
        >
          <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-600 to-gray-300">
        ...
        <div className="grid gap-6 lg:grid-cols-4">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className="mb-6">
                <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-600 to-gray-300">{plan.name}</h3>
                <div className="mt-2">
                  <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-600 to-gray-300">{plan.price}</span>
                  {plan.price !== "$0" && (
              ...
              <div className="mb-6 p-4 bg-gradient-to-r from-purple-900 to-black rounded-xl">
                <h4 className="text-sm font-semibold text-gray-300 mb-2">Investor Perks</h4>
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div>
                    <div className="text-lg font-bold text-gray-300">2x</div>
                    <div className="text-xs text-gray-300">Deal Priority</div>
                  </div>
                  <div>
                    <div className="text-lg font-bold text-gray-300">24h</div>
                    <div className="text-xs text-gray-300">Response Time</div>
                  </div>
                  <div>
                    <div className="text-lg font-bold text-gray-300">VIP</div>
              ...
              {/* Support Level */}
              <div className="mb-6 p-3 bg-gradient-to-r from-purple-900 to-black rounded-lg">
                <span className="text-xs font-medium text-gray-300">Support:</span>
                <p className="text-sm text-gray-300 mt-1">{plan.support}</p>
              </div>
              ...
              <motion.button
                ...
                className={`
                  ...
                  ${plan.recommended 
                    ? 'bg-gradient-to-r from-purple-600 to-black text-white hover:from-indigo-700 hover:to-purple-700' 
                    : plan.price === "$0"
                    ? 'bg-gradient-to-r from-purple-600 to-black text-white hover:from-indigo-700 hover:to-purple-700'
                    : 'bg-gradient-to-r from-purple-600 to-black text-white hover:from-indigo-700 hover:to-purple-700'
                  }
