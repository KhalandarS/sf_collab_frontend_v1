      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            {/* Model Status */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border shadow-sm mb-4">
          ...
          <div className="grid gap-8 lg:grid-cols-4">
            ...
            <div className="lg:col-span-1">
              <Card className="bg-white/90 backdrop-blur-sm border-gray-200 shadow-lg h-fit sticky top-8">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <h4 className="text-sm font-semibold mb-2">Model Info</h4>
                    <div className="space-y-2 text-xs text-gray-600">
                      ...
                      <div className="flex justify-between">
                        <span>Context:</span>
                        <span className="font-medium">8K tokens</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Status:</span>
              ...
              {/* Quick Prompts */}
              <Card className="mt-6 bg-white/90 backdrop-blur-sm border-gray-200 shadow-lg">
            ...
            <div className="lg:col-span-3">
              <Card className="bg-white/90 backdrop-blur-sm border-gray-200 shadow-lg h-[600px] flex flex-col">
                        ...
                        <div className={`flex items-center gap-2 mt-1 text-xs ${
                          ...
                          {message.role === 'assistant' && !message.isError && (
                            <>
                              ...
                              <span className="text-purple-600 font-medium">{message.model || 'Qwen 2.5'}</span>
                            </>
                          )}
