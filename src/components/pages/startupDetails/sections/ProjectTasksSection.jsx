...
import { CheckCircle, Clock, AlertCircle, Plus, Trash2, Settings, Eye, EyeOff } from "lucide-react";
...
export default function ProjectTasksSection({ tasks, isCreator, setTasks, startupId, teamMembers }) {
  ...
  const isVisible = (task) => {
    ...
    if (task.visible_by === 'team') {
      // Assuming team members are passed as props
                    ...
                    <motion.div className="flex gap-2" whileHover={{ scale: 1.02 }}>
                      ...
                      {task.status !== "completed" && (
                        <Button
                          ...
                          className="border-green-600/50 text-green-400 hover:bg-green-600/10 hover:border-green-500 transition-all"
                        >
                    ...
                    {isCreator && (
                      <motion.div className="flex gap-2" whileHover={{ scale: 1.02 }}>
                        <Button
                          ...
                          className="border-gray-600 text-black hover:border-blue-500 hover:text-blue-400 transition-all"
                        >
                        ...
                        <Button
                          ...
                          className="border-red-600/50 text-red-400 hover:bg-red-600/10 hover:border-red-500 transition-all"
                        >
