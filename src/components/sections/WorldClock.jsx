...
const TIME_ZONES = [
  ...
  { city: "So Paulo", country: "Brazil", flag: <BR className="w-6 h-4" />, offset: -3, utc: "UTC-3", gradient: "from-green-500/30 via-yellow-500/30 to-blue-500/30", color: "rgba(16, 185, 129, 0.15)" },
