          ...
          <div className='flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto'>
            ...
            <div className="relative w-full sm:w-auto">
              ...
              <input
                ...
                placeholder="Search..."
                className="relative w-full sm:w-[320px] px-4 py-2.5 pl-10 bg-transparent rounded-full focus:outline-none focus:ring-2 focus:ring-white/30 text-white placeholder-gray-300 transition-all duration-200 border border-transparent"
              />
